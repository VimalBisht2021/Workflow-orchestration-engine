...
import { ConnectEdgeCommand, DisconnectEdgeCommand } from '../../core/commands/edge-commands';
import { CopySelectionCommand, PasteCommand, DuplicateCommand, DeleteSelectionCommand } from '../../core/commands/clipboard-commands';
...
export const WorkflowCanvasInner = () => {
